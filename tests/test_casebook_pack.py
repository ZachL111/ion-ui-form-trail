"""Regression checks for the ion-ui-form-trail casebook."""
...
from casebook.harness import assert_expected, ion_ui_form_trail_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ion_ui_form_trail_summary(), assert_expected())
