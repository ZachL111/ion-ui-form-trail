...
$repo = "ion-ui-form-trail"
$language = "Lua"
$category = "Frontend apps"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/ion-ui-form-walkthrough.md")) {
